...
\item \textbf{Flyweight}: utile quando abbiamo un grande numero di oggetti che
condividono caratteristiche immutabili: decidiamo di utilizzare la condivisione delle risorse per risparmiare memoria.
